...
describe('stats', () => {
    ...
    it('should only return the specified number of days', async () => {
        const { aggregateByDate: test1, byCounty: test1County, byDate: test1Date } = await stats.getTestingData()
        ...
        const { aggregateByDate: test2, byCounty: test2County, byDate: test2Date } = await stats.getTestingData()
